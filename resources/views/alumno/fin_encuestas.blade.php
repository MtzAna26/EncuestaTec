...
<body>
    ...
    <main class="absolute top-1/2 transform -translate-y-1/3 flex items-center justify-center w-full">
        <div class="bg-[#800000] text-center mx-4 md:mx-auto p-8 rounded-lg shadow-lg w-full md:w-2/3 lg:w-1/2">
            ...
            <p class="text-lg mb-4 text-black">Tu opinión es fundamental para nosotros y nos ayudará a mejorar continuamente.</p>
