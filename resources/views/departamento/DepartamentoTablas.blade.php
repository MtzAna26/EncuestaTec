...
<head>
    ...
    <style>
        ...
        .table1 {
            width: auto;
            /* La tabla también debe ser de tamaño automático */
            border-collapse: collapse;
            /* Para evitar espacios entre bordes */
        }
                        ...
                        <tbody>
                            @foreach ($datos as $clave => $valor)
                                <tr>
                                    ...
                                    @if ($valor[0] + $valor[1] + $valor[2] + $valor[3] + $valor[4] == 0)
                                        ...
                                        @if (
                                            ($valor[0] * 1 + $valor[1] * 2 + $valor[2] * 3 + $valor[3] * 4 + $valor[4] * 5) /
                                                ($valor[0] + $valor[1] + $valor[2] + $valor[3] + $valor[4]) <
                                                3.6)
                                            {
                                            <td style=" background-color: rgb(255, 255, 0);">
                                                <p>{{ ($valor[0] * 1 + $valor[1] * 2 + $valor[2] * 3 + $valor[3] * 4 + $valor[4] * 5) / ($valor[0] + $valor[1] + $valor[2] + $valor[3] + $valor[4]) }}
                                                </p>
                                            </td>
                                </tr>
                            }@else{
                            ...
                            <tr>
                                ...
                                @if ($contadorRes / $contadorbueltas < 3.6)
                                    {
                                    <td style=" background-color: rgb(228,12,15);">
                                        <b>{{ $contadorRes / $contadorbueltas }}</b></td>
                                }@else{
