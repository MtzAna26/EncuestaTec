...
<body class="bg-gray-100">
    ...
    <div class="flex justify-center">
        ...
        &nbsp;
        <button id="guardarGraficaServiciosEscolares" class="bg-blue-900 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded">
            Guardar Gráfica Servicios Escolares
        </button>
    </div>
    ...
    <script>
        document.getElementById('guardarGraficaServiciosEscolares').addEventListener('click', function() {
            ...
            downloadLink.download = 'grafica_servicios_escolares.png';
