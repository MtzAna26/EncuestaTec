...
<body class="bg-gray-100">
    ...
    <div class="flex justify-center">
        ...
        &nbsp;
        <button id="guardarGraficaServicioSocial" class="bg-blue-900 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded">
            Guardar Gráfica Servicio Social
        </button>
    </div>
...
<div class="chart-container">
    ...
    <script>
        document.getElementById('guardarGraficaServicioSocial').addEventListener('click', function() {
            ...
            downloadLink.download = 'grafica_servicio_social.png';
