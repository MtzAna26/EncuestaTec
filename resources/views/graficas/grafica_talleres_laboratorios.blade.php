...
<body class="bg-gray-100">
    ...
    <div class="text-center">
        <h1 class="text-4xl font-bold">Gráfica Departamento Talleres y Laboratorios</h1>   
        <h6 class="text-3xl font-bold">{{ $periodo->nombre }}</h6> 
    </div>

    <br>
    <div class="flex justify-center">
        <a href="{{ route('generate_reporte_talleres_laboratorio_pdf', ['periodo_id' => $periodo->id]) }}" class="bg-red-900 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
            Generar PDF
        </a>
        ...
        &nbsp;
        <button id="guardarGraficaTalleresLaboratorios" class="bg-blue-900 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded">
            Guardar Gráfica Talleres y Laboratorios
        </button>
    </div>
    ...
    <script>
        document.getElementById('guardarGraficaTalleresLaboratorios').addEventListener('click', function() {
            ...
            downloadLink.download = 'grafica_talleres_laboratorios.png';
