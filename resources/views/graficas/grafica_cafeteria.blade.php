...
<body class="bg-gray-100">
    ...
    <div class="text-center">
        <h1 class="text-4xl font-bold">Gráfica Departamento Cafeteria</h1>   
        @if($periodo)
    ...
    <div class="flex justify-center">
        <a href="{{ route('generate_cafeteria_pdf', ['periodo_id' => $periodo->id]) }}" class="bg-red-900 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
            Generar PDF
        </a>
        ...
        &nbsp;
        <button id="guardarGraficaCafeteria" class="bg-blue-900 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded">
            Guardar Gráfica Cafeteria
        </button>
    </div>
    ...
    <script src="{{ asset('js/graficaCafeteria.js') }}"></script>
    <script>
        document.getElementById('guardarGraficaCafeteria').addEventListener('click', function() {
            ...
            downloadLink.download = 'grafica_cafeteria.png';
