...
<body class="bg-gray-100">
    ...
    <div class="text-center">
        <h1 class="text-4xl font-bold">Gráfica Departamento Recursos Financieros</h1>   
        <h5 class="text-2xl font-semibold">Periodo Actual: {{ $periodo->nombre }}</h5>
    </div>

    <br>
    <div class="flex justify-center">
        <a href="{{ route('generate_reporte_financieros_pdf') }}" class="bg-red-900 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
            Generar PDF
        </a>
        &nbsp;
        ...
        &nbsp;
        <button id="guardarGraficaRecursosFinancieros" class="bg-blue-900 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded">
            Guardar Gráfica Recursos Financieros
        </button>
    </div>
<div class="chart-container">
    ...
    <script>
        document.getElementById('guardarGraficaRecursosFinancieros').addEventListener('click', function() {
            ...
            downloadLink.download = 'grafica_recursos_financieros.png';
