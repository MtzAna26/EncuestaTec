            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($periodos as $periodo)
                    <div class="bg-white shadow-md rounded-lg p-6 border border-gray-200">
                        ...
                        <a href="{{ route('graficas.grafica_talleres_laboratorios', ['periodo_id' => $periodo->id]) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4">
                            Ver Gráfica
                        </a>
