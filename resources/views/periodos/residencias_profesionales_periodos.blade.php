...
<head>
    ...
    <title>Periodos de Residencias Profesionales</title>
...
<body>
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-semibold mb-4">Periodos de Residencias Profesionales</h1>
    ...
    <script>
        function verGrafica(periodoId) {
            window.location.href = '/graficas/residencias_profesionales/' + periodoId;
        }
    </script>
