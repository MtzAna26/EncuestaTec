...
<head>
    ...
    <title>Periodos de Recursos Financieros</title>
...
<body>
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-semibold mb-4">Períodos Disponibles</h1>
    ...
    <script>
        function verGrafica(periodoId) {
            window.location.href = '/graficas/recursos_financieros/' + periodoId;
        }
    </script>
