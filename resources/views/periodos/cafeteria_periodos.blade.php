...
<head>
    ...
    <title>Periodos Disponibles para Cafetería</title>
...
<body>
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-semibold mb-4">Periodos Disponibles para Cafeteria</h1>
    ...
    <script>
        function verGrafica(periodoId) {
            window.location.href = '/graficas/cafeteria/' + periodoId;
        }
    </script>
</body>
</html>
