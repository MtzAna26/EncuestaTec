    ...
    <head>
        ...
        <title>Periodos Disponibles para Servicio Social</title>
    ...
    <body>
        <div class="container mx-auto px-4 py-8">
            <h1 class="text-3xl font-semibold mb-4">Periodos Disponibles para Servicio Social</h1>
        ...
        <script>
            function verGrafica(periodoId) {
                window.location.href = '/graficas/servicio_social/' + periodoId;
            }
        </script>
    </body>
    </html>
