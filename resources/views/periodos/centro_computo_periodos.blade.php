...
<head>
    ...
    <title>Periodos de Centro de Cómputo</title>
...
<body>
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-semibold mb-4">Períodos Disponibles para Centro de Cómputo</h1>
    ...
    <script>
        function verGrafica(periodoId) {
            window.location.href = '{{ route("graficas.centro_computo", ["periodo_id" => ":periodo_id"]) }}'.replace(':periodo_id', periodoId);
        }
    </script>
</body>
</html>
