...
<body class="bg-gray-100" onload="init()">
    ...
    <div class="flex">
        ...
        <button id="menu-toggle"
            class="menu-toggle-btn bg-gray-800 text-white p-2 fixed z-20 rounded-r-md focus:outline-none">
        ...
        <nav id="menu" class="menu-vertical w-64 bg-gray-800 p-6 text-white z-10 menu-hidden">
            <a href="{{ route('usuarios.index') }}"
                class="block bg-red-900 hover:bg-red-600 rounded py-2 px-4 mb-2 transition-colors duration-200">Ver
                Usuarios</a>
            <a href="{{ route('admin.quejas') }}"
                class="block bg-red-700 hover:bg-red-500 rounded py-2 px-4 mb-2 transition-colors duration-200">Buzón de
                Quejas</a>
            <a href="{{ route('seleccionarPeriodo') }}"
                class="block bg-red-900 hover:bg-red-600 rounded py-2 px-4 mb-2 transition-colors duration-200">
                Gráfica General
            </a>


            <a href="{{ route('carreras.semestres.alumnos.lista', ['carrera' => 'Ingeniería Industrial (Escolarizado)', 'semestre' => 1]) }}"
                class="block bg-red-700 hover:bg-red-500 rounded py-2 px-4 mb-2 transition-colors duration-200">Buscar
                Alumno</a>
            <div class="relative">
                <button id="agregar-btn"
                    class="w-full bg-red-900 hover:bg-red-600 text-white font-bold py-2 px-4 rounded flex items-center justify-between transition-colors duration-200">
                    <span>Alumnos</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
            ...
            <div class="mt-auto">
                <form id="logout-form" action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit"
                        class="text-red-600 hover:text-red-700 focus:outline-none flex items-center w-full justify-start bg-red-100 hover:bg-red-200 px-4 py-2 rounded-md">
                        <span>Salir</span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-1" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path fill-rule="evenodd"
                                d="M6 3a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zM4 9a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zm1 5a1 1 0 100 2h6a1 1 0 100-2H5z"
            ...
            <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <form method="POST" action="{{ route('users.store') }}" class="space-y-4">
                        @csrf
                        <div>
                            <label for="name" class="block text-base font-medium text-gray-800">Nombre
                                Completo</label>
                        ...
                        <div>
                            <label for="email" class="block text-base font-medium text-gray-800">Correo
                                Electrónico</label>
                        ...
                        <div>
                            <label for="password_confirmation"
                                class="block text-base font-medium text-gray-800">Confirmar Contraseña</label>
                    ...
                    <div class="overflow-y-auto max-h-96">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><strong><span
                                                style="font-weight: 700">CENTRO INFORMACION</span></strong></td>
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><strong><span
                                                style="font-weight: 700">COORDINACIÓN DE CARRERAS</span></strong></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><strong><span
                                                style="font-weight: 700">RECURSOS FINANCIEROS</span></strong></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><strong><span
                                                style="font-weight: 700">RESIDENCIAS PROFESIONALES</span></strong></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><strong><span
                                                style="font-weight: 700">CENTRO DE CÓMPUTO</span></strong></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><strong><span
                                                style="font-weight: 700">SERVICIO SOCIAL</span></strong></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><strong><span
                                                style="font-weight: 700">SERVICIOS ESCOLARES</span></strong></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><strong><span
                                                style="font-weight: 700">BECAS</span></strong></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><strong><span
                                                style="font-weight: 700">TALLERES Y LABORATORIOS</span></strong></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><strong><span
                                                style="font-weight: 700">CAFETERIA</span></strong></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><strong><span
                                                style="font-weight: 700">SERVICIO MÉDICO</span></strong></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><strong><span
                                                style="font-weight: 700">ACTIVIDADES CULTURALES Y
                                                DEPORTIVAS</span></strong></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
