...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <nav id="menu" class="menu-vertical w-64 bg-gray-800 p-6 text-white z-10 menu-hidden">
            ...
            <a href="{{ route('grafica.general') }}" class="block bg-red-900 hover:bg-red-600 rounded py-2 px-4 mb-2 transition-colors duration-200">Gráfica General</a>
            ...
            <div class="relative">
                ...
                <div id="opciones-agregar" class="hidden absolute right-0 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg z-10">
                    ...
                    <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Carreras</a>
                </div>
            </div>
<br>
<div class="mt-auto">
