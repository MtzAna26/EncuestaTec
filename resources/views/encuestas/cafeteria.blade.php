...
<body>
    ...
    <div class="container mx-auto px-4 bg-gray-200">
        <h2 class="text-3xl font-semibold mb-4">DEPARTAMENTO DE  CAFETERIA</h2>
        ...
        <p class="mb-4">Te invitamos a participar en nuestra encuesta y compartir tu opinión. 
            ...
            <form id="encuestaForm" action="{{ route('encuestas.guardar_cafeteria') }}" method="POST">
                ...
                <table class="w-full">
                    ...
                    <tr>
                        <td>1. Me atienden con amabilidad y respeto.</td>
                    ...
                    <tr>
                        <td>2. El horario de servicio es adecuado.</td>
                    ...
                    <tr>
                        <td>3. Las condiciones de higiene y limpieza del lugar son las adecuadas.</td>
                    ...
                    <tr>
                        <td>4. El personal que me atiende toma las medidas de higiene adecuadas (porta cubre bocas, guantes, malla para el cabello, etc.)</td>
                    ...
                    <tr>
                        <td>5. El tiempo para la entrega de los alimentos es adecuado.</td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_5" name="Serpregunta_5" value="5"><label for="Serpregunta_5_5"></label></td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_4" name="Serpregunta_5" value="4"><label for="Serpregunta_5_4"></label></td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_3" name="Serpregunta_5" value="3"><label for="Serpregunta_5_3"></label></td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_2" name="Serpregunta_5" value="2"><label for="Serpregunta_5_2"></label></td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_1" name="Serpregunta_5" value="1"><label for="Serpregunta_5_1"></label></td>
                    </tr>

                    <tr>
                        <td>6. Identifico fácilmente la lista de precios.</td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_5" name="Serpregunta_6" value="5"><label for="Serpregunta_5_5"></label></td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_4" name="Serpregunta_6" value="4"><label for="Serpregunta_5_4"></label></td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_3" name="Serpregunta_6" value="3"><label for="Serpregunta_5_3"></label></td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_2" name="Serpregunta_6" value="2"><label for="Serpregunta_5_2"></label></td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_1" name="Serpregunta_6" value="1"><label for="Serpregunta_5_1"></label></td>
                    </tr>

                    <tr>
                        <td>7. Considero que los precios son apropiados.</td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_5" name="Serpregunta_7" value="5"><label for="Serpregunta_5_5"></label></td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_4" name="Serpregunta_7" value="4"><label for="Serpregunta_5_4"></label></td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_3" name="Serpregunta_7" value="3"><label for="Serpregunta_5_3"></label></td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_2" name="Serpregunta_7" value="2"><label for="Serpregunta_5_2"></label></td>
                        <td class="right-column"><input type="radio" id="Serpregunta_5_1" name="Serpregunta_7" value="1"><label for="Serpregunta_5_1"></label></td>
                    </tr>
