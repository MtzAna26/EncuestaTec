...
<body>
    ...
    <div class="container mx-auto px-4 bg-gray-200">
        ...
        <p class="mb-4">Te invitamos a participar en nuestra encuesta y compartir tu opinión. 
            ...
            <form id="encuestaForm" action="{{ route('encuestas.guardar_talleres_laboratorios') }}" method="POST">
                ...
                <table class="w-full">
                    ...
                    <tr>
                        <td>1. La limpieza en los talleres y los laboratorios es adecuada</td>
                    ...
                    <tr>
                        <td>2. Los materiales y/o equipo para realizar las prácticas siempre están disponibles</td>
                    ...
                    <tr>
                        <td>3. Las medidas de seguridad son las apropiadas dentro del Taller y/o Laboratorio </td>
                    ...
                    <tr>
                        <td>4. Identifico fácilmente el reglamento del Taller y/o Laboratorio</td>
                    ...
                    <tr>
                        <td>5. El coordinador de Talleres y Laboratorios brinda el apoyo necesario para la realización de las prácticas.</td>
