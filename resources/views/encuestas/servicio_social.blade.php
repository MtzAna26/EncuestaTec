...
@endif
    <div class="container mx-auto px-4 bg-gray-200">
        ...
        <p class="mb-4">Te invitamos a participar en nuestra encuesta y compartir tu opinión. 
            ...
            <form action="{{ route('encuestas.guardar_servicio_social') }}" method="POST">
    ...
    <table class="w-full">
        ...
        <tr>
            <td>1. La oficina de Servicio Social tiene un horario adecuado para realizar mis trámites. </td>
        ...
        <tr>
            <td>2. La oficina de Servicio Social me ofrece un catálogo de instituciones en donde pueda realizarlo.</td>
        ...
        <tr>
            <td>3. La oficina de Servicio Social me brinda el apoyo para desarrollar mis actividades. </td>
        ...
        <tr>
            <td>4. Me proporcionan atención  adecuada cuando realizo mis trámites. </td>
        ...
        <tr>
            <td>5. Me apoyan adecuadamente en la búsqueda, en caso de no tener en donde hacerlo.</td>
        ...
        <tr>
            <td>6. Me proporcionan asesoría para desarrollar en forma adecuada el Servicio Social.</td>
        ...
        <tr>
            <td>7. Me atienden en forma inmediata al solicitar información.</td>  
        ...
        <tr>
            <td>8. Mantienen una relación atenta conmigo durante toda mi estancia en su oficina.</td>  
