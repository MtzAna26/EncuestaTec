...
<body>
    ...
    <div class="container mx-auto px-4 bg-gray-200">
        <h2 class="text-3xl font-semibold mb-4">DEPARTAMENTO DE BECAS</h2>
        ...
        <p class="mb-4">Te invitamos a participar en nuestra encuesta y compartir tu opinión. 
            ...
            <form id="encuestaForm" action="{{ route('encuestas.guardar_becas') }}" method="POST">
                ...
                <table class="w-full">
                    ...
                    <tr>
                        <td>1. Se cumple con el horario de atención establecido.</td>
                    ...
                    <tr>
                        <td>2. Conozco a dónde dirigirme para que me informen sobre el trámite de solicitud de beca.</td>
                    ...
                    <tr>
                        <td>3. Se dan a conocer oportunamente y apropiadamente las convocatorias para los diferentes tipos de becas.</td>
                    ...
                    <tr>
                        <td>4. Resuelven mis dudas oportuna y claramente.</td>
                    ...
                    <tr>
                        <td>5. Si se presenta algún problema con mi trámite me lo informan oportunamente.</td>
