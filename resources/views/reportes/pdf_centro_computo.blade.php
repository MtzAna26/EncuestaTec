...
<head>
    ...
    <title>Reporte Departamento Centro Computo </title>
</head>
<body class="bg-gray-100">
    <div class="container mx-auto py-8 px-4">
        <h1 class="text-center text-3xl font-bold mb-8">Reporte Centro Computo</h1>
        ...
        <!-- <a href="{{--route('download-centro-computo')--}}" class="bg-blue-900 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-4 hide-on-print">
            Descargar PDF
        </a>-->
        &nbsp;
