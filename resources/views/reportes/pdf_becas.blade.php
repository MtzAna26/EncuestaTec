...
<body class="bg-gray-100">
    <div class="container mx-auto py-8 px-4">
        <h1 class="text-center text-3xl font-bold mb-8">Reporte Becas</h1>
        <h6 class="text-center text-3xl font-bold mb-8">Periodo: {{ $periodo->nombre }}</h6>
        ...
        <!--<a href="{{--route('download-becas')--}}" class="bg-blue-900 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-4 hide-on-print">
            Descargar PDF
        </a>-->
        &nbsp;
